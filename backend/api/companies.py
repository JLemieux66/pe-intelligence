...
def get_companies(
    ...
    filters = {
        'search': search,
        'pe_firm': pe_firm,
        'pe_firm_filter_mode': pe_firm_filter_mode,
        'status': status,
        'industry': industry,
        'industry_filter_mode': industry_filter_mode,
        'industry_group': industry_group,
        'industry_group_filter_mode': industry_group_filter_mode,
        'industry_sector': industry_sector,
        'industry_sector_filter_mode': industry_sector_filter_mode,
        'verticals': verticals,
        'verticals_filter_mode': verticals_filter_mode,
        'country': country,
        'country_filter_mode': country_filter_mode,
        'state_region': state_region,
        'state_region_filter_mode': state_region_filter_mode,
        'city': city,
        'city_filter_mode': city_filter_mode,
